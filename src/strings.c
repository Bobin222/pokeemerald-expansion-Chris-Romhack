...
const u8 gText_ExpandedPlaceholder_Brendan[] = _("CHRIS");
const u8 gText_ExpandedPlaceholder_May[] = _("COURTNEY");
...
const u8 gText_DadsAdvice[] = _("GRANDPA's advice…\n{PLAYER}, there's a time and place for\leverything!{PAUSE_UNTIL_PRESS}");
