...
static const u8 *const sMalePresetNames[] = {
    ...
    COMPOUND_STRING("Christo"),
    COMPOUND_STRING("Big G"),
    COMPOUND_STRING("Big C"),
    COMPOUND_STRING("BigGing"),
    COMPOUND_STRING("BGinger"),
    COMPOUND_STRING("Cristop"),
    COMPOUND_STRING("Chrissy"),
    COMPOUND_STRING("Kristof"),
    COMPOUND_STRING("Kristo"),
    COMPOUND_STRING("Kristos"),
    COMPOUND_STRING("Khristo"),
    COMPOUND_STRING("Crisden"),
    COMPOUND_STRING("Chris"),
    COMPOUND_STRING("Criost"),
    COMPOUND_STRING("Crisjan"),
...
static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("Courtny"),
    COMPOUND_STRING("Court"),
    COMPOUND_STRING("C dawg"),
    COMPOUND_STRING("Courtni"),
    COMPOUND_STRING("Courtne"),
    COMPOUND_STRING("Courtny"),
    COMPOUND_STRING("Kortnie"),
    COMPOUND_STRING("Kortnii"),
    COMPOUND_STRING("Kortnie"),
    COMPOUND_STRING("Courtny"),
    COMPOUND_STRING("Cortnay"),
    COMPOUND_STRING("Cortney"),
    COMPOUND_STRING("Courtny"),
    COMPOUND_STRING("Courtne"),
    COMPOUND_STRING("Kortney"),
    COMPOUND_STRING("Kourtne"),
    COMPOUND_STRING("Kourtni"),
    COMPOUND_STRING("Kourtni"),
    COMPOUND_STRING("Courton"),
    COMPOUND_STRING("Courtny")
};
