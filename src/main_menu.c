...
static const u8 *const sMalePresetNames[] = {
    ...
    COMPOUND_STRING("Christopher"),
    COMPOUND_STRING("Big G"),
    COMPOUND_STRING("Big C"),
    COMPOUND_STRING("Big Ging"),
    COMPOUND_STRING("Big Ginger"),
    COMPOUND_STRING("Christoph"),
    COMPOUND_STRING("Chrissy"),
    ...
    COMPOUND_STRING("Crisjean"),
    COMPOUND_STRING("C Dog"),
    COMPOUND_STRING("Kristopher"),
    COMPOUND_STRING("Kristoph"),
    COMPOUND_STRING("Kris")
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("Courtney"),
    COMPOUND_STRING("Court"),
    COMPOUND_STRING("C dawg"),
    COMPOUND_STRING("Courtni"),
    COMPOUND_STRING("Courtnee"),
    COMPOUND_STRING("Courtnie"),
    COMPOUND_STRING("Kortnie"),
    COMPOUND_STRING("Kortnii"),
    COMPOUND_STRING("Kortniee"),
    COMPOUND_STRING("Courtenay"),
    COMPOUND_STRING("Courtenayy"),
    COMPOUND_STRING("Courtninie"),
    COMPOUND_STRING("Courtnine"),
    COMPOUND_STRING("Courtknee"),
    COMPOUND_STRING("Kortney"),
    COMPOUND_STRING("Kourtnee"),
    COMPOUND_STRING("Kourtnie"),
    COMPOUND_STRING("Kourtnii"),
    COMPOUND_STRING("Courtonee"),
    COMPOUND_STRING("Yentrouc")
};
