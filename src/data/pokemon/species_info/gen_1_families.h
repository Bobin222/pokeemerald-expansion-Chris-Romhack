...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_VENONAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_VENOMOTH}),
    },
    ...
    [SPECIES_SLOWPOKE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_SLOWBRO}
                            #if P_GEN_2_CROSS_EVOS
...
#define MAGNEMITE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_2 ? TYPE_STEEL : TYPE_ELECTRIC)
    ...
    [SPECIES_DODUO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_DODRIO}),
    },
    ...
    [SPECIES_GRIMER_ALOLA] =
    {
        ...
        .formSpeciesIdTable = sGrimerFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MUK_ALOLA}),
    },
...
#define GENGAR_SP_DEF (P_UPDATED_STATS >= GEN_2 ? 75 : 130)
    ...
    [SPECIES_KOFFING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_WEEZING}
                #if P_GALARIAN_FORMS
    ...
    [SPECIES_RHYHORN] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_RHYDON}),
    },
    ...
    [SPECIES_HORSEA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_SEADRA}),
    },
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_DRAGONAIR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_DRAGONITE}),
    },
