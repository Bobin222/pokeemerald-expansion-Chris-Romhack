...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_PANGORO}),
    },
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx, _overworldAnim)   \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 22, SPECIES_DOUBLADE}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_INKAY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_MALAMAR}),
    },
    ...
    [SPECIES_BINACLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_BARBARACLE}),
    },
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_CLAWITZER}),
    },
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_TYRANTRUM}),
    },
    ...
    [SPECIES_AMAURA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_AURORUS}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_SLIGGOO}
                            #if P_HISUIAN_FORMS
    ...
    [SPECIES_PHANTUMP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_TREVENANT},
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GOURGEIST_AVERAGE},
    ...
    [SPECIES_PUMPKABOO_SMALL] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GOURGEIST_SMALL},
    ...
    [SPECIES_PUMPKABOO_LARGE] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GOURGEIST_LARGE},
    ...
    [SPECIES_PUMPKABOO_SUPER] =
    {
        ...
        .eggMoveLearnset = sPumpkabooEggMoveLearnset,
        .formSpeciesIdTable = sPumpkabooFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_GOURGEIST_SUPER},
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 32, SPECIES_AVALUGG}
                            #if P_HISUIAN_FORMS
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_NOIVERN}),
    },
