...
static const u16 sPrizeListHyperVoice[]  = {ITEM_TM_HYPER_VOICE,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const u16 sPrizeListBraveBird[]     = {ITEM_TM_BRAVE_BIRD,  ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
