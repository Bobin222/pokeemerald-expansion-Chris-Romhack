...
#define FLAG_HIDDEN_ITEM_ROUTE_113_MAX_ETHER                 (FLAG_HIDDEN_ITEMS_START + 0x1E)
...
#define FLAG_HIDDEN_ITEM_OLDALE_TOWN_ADAMANT_MINT    (FLAG_HIDDEN_ITEMS_START + 0x70)
#define FLAG_HIDDEN_ITEM_OLDALE_TOWN_MODEST_MINT     (FLAG_HIDDEN_ITEMS_START + 0x71)
...
#define FLAG_ITEM_ROUTE_113_DRAIN_PUNCH                             0x3F4
...
#define FLAG_ITEM_ROUTE_112_TM_POISON_JAB                           0x493 // Unused Flag
...
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_STEVENS_ROOM_FIRE_STONE      (SYSTEM_FLAGS + 0x24) // Flags for Stones hidden in Steven's Room in Granite Cave
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_STEVENS_ROOM_WATER_STONE     (SYSTEM_FLAGS + 0x25) // Flags for Stones hidden in Steven's Room in Granite Cave
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_STEVENS_ROOM_THUNDER_STONE   (SYSTEM_FLAGS + 0x26) // Flags for Stones hidden in Steven's Room in Granite Cave
#define FLAG_HIDDEN_ITEM_GRANITE_CAVE_STEVENS_ROOM_ICE_STONE       (SYSTEM_FLAGS + 0x27) // Flags for Stones hidden in Steven's Room in Granite Cave
